...
import { Home, Building2, Sparkles, Hammer, Trees, Waves, ArrowRight } from "lucide-react";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-white border border-[#E2EDF4] flex items-center justify-center mb-4 group-hover:bg-[#00B4D8] group-hover:border-[#00B4D8] transition-all duration-300">
