...
export const metadata: Metadata = {
  ...
  description:
    "Клининговая компания PrimeClean в Минске. Уборка квартир, офисов, домов. Генеральная уборка и уборка после ремонта. Опытная команда, экологичные средства. Звоните: +375 (44) 478-93-60",
  keywords: [
